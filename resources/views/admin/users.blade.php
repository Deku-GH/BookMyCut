                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div style="color:var(--text-main); font-weight: 600;">{{ $u->firstname }} {{ $u->lastname }}</div>
                    ...
                    <td>
                        ...
                        <div style="font-size: 0.75rem; color: var(--text-muted)">{{ $u->telephone ?? 'Non renseigné' }}</div>
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="pill pg">
                            <i class="bi bi-circle-fill me-1" style="font-size: 0.4rem;"></i> Actif
                        </span>
                    </td>
                </tr>
                @empty
