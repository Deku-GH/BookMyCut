...
<body>
                        ...
                        <tr data-name="{{ strtolower($day) }}">
                            ...
                            <td>
                                ...
                                @if(count($daySlots) > 0)
                                    @foreach($daySlots as $slot)
                                        <span class="pill pb" style="margin-right:6px">
                            ...
                            <td>
                                <div style="display:flex;gap:0.35rem">
                                    ...
                                    {{-- ADD SLOT --}}
                                    <button class="btn-sm eg" data-bs-toggle="modal" data-bs-target="#createSlot"
                                        onclick="setDay('{{ $day }}')">
                                        <i class="bi bi-plus me-1"></i>Ajouter
                                    </button>

                                    {{-- OPTIONAL EDIT ALL DAY --}}
                                    <button class="btn-sm eg" onclick="editDay('{{ $day }}')">
                        ...
                        <tr class="empty-row">
                            <td colspan="3">
                                <div
                                    ...
                                    <i class="bi bi-clock" style="font-size:2.5rem;color:var(--muted)"></i>
                                    <span>Aucun créneau trouvé. Ajoutez votre planning.</span>

                                    <button class="btn-g" data-bs-toggle="modal" data-bs-target="#createSlot">
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{ route('store.timeslot') }}" class="modal-content">
                @csrf
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label"> <span style="color:var(--red)">*</span></label>
