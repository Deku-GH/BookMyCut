    ...
    <div class="container-fluid p-0">
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <div class="card-luxe">
                        <h5 class="font-playfair text-white mb-4"><i class="bi bi-person-gear me-2 text-gold"></i>Modifier
                            mes
                            informations</h5>
                        ...
                        <form action="{{ route('barber.profile.update', ) }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 mt-5">
                                    <h6
                                        class="font-playfair text-white mb-3 border-bottom border-white border-opacity-10 pb-2">
                                ...
                                <div class="row g-2 mb-4">
                                    <div class="col-6">
                                        <div class="p-2 rounded-3 text-center"
                                            ...
                                            <span
                                                class="small text-white">{{ $booking->timeSlot->start_time ?? '--:--' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="p-2 rounded-3 text-center"
