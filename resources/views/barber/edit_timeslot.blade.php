...
<body>
    ...
    <div class="main" id="mn">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{ route('timeslots.update', $timeslot->id) }}" class="modal-content">
                @csrf
                @method('PUT')

                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="bi bi-pencil me-2" style="color:var(--gold)"></i>Modifier le créneau
                    </h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-semibold">
                                Jour <span style="color:var(--red)">*</span>
                            </label>
                            <select class="form-select w-100 py-2" name="day" required>
                                <option value="" disabled {{ empty($timeslot->day) ? 'selected' : '' }}>
                                    -- Sélectionner --
                                </option>

                                @foreach($days as $key => $label)
                                    <option value="{{ $key }}" {{ $timeslot->day == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label fw-semibold">
                                Heure de début <span style="color:var(--red)">*</span>
                            </label>
                            <input type="time" class="form-control py-2" name="start_time"
                        ...
                        <div class="col-sm-6">
                            <label class="form-label fw-semibold">
                                Heure de fin <span style="color:var(--red)">*</span>
                            </label>
                            <input type="time" class="form-control py-2" name="end_time"
