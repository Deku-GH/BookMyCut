    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <div class="sc">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <div class="sc-lbl small text-uppercase" style="letter-spacing: 1px; color: var(--muted);">RDV
                            aujourd'hui</div>
                ...
                <div class="mt-3"
                    style="height: 3px; background: rgba(255,255,255,0.05); border-radius: 10px; overflow: hidden;">
        ...
        <div class="col-md-4">
            <div class="sc">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <div class="sc-lbl small text-uppercase" style="letter-spacing: 1px; color: var(--muted);">Services
                            actifs</div>
        ...
        <div class="col-md-4">
            <div class="sc">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <div class="sc-lbl small text-uppercase" style="letter-spacing: 1px; color: var(--muted);">Revenu du
                            mois</div>
                        <div class="sc-val h2 fw-bold mb-0 text-white">{{ number_format($monthlyRevenue ?? 0, 0) }} <small
                                class="h6 text-gold">MAD</small></div>
                    </div>
                    <div class="u-av"
                ...
                <div class="mt-3"
                    style="height: 3px; background: rgba(255,255,255,0.05); border-radius: 10px; overflow: hidden;">
                    <div style="height: 100%; background: var(--green); width: 75%; box-shadow: 0 0 10px var(--green);">
                    </div>
                </div>
            </div>
        </div>
